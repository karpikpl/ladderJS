...
var _onStats = require('./onStats');

var _onStats2 = _interopRequireDefault(_onStats);
      ...
      case 0:
        try {
          ...
          if (document.querySelector('.stats')) {
            (0, _onStats2['default'])(function (stats) {
...
},{"./onStats":2,"babel/polyfill":95}],2:[function(require,module,exports){
/**
 * Babel Starter Kit | https://github.com/babel/babel-starter-kit
 * Copyright (c) Konstantin Tarkus <hello@tarkus.me> | The MIT License
 */
 ...
 */
var onStats = (function () {
  var key = 'github.repo';
  return function callee$1$0(callback) {
    var _ref, value, timestamp, response, data;

    return regeneratorRuntime.async(function callee$1$0$(context$2$0) {
      while (1) switch (context$2$0.prev = context$2$0.next) {
        case 0:
          _ref = JSON.parse(window.localStorage.getItem(key)) || {};
          value = _ref.value;
          ...
          context$2$0.next = 7;
          return regeneratorRuntime.awrap(load('https://api.github.com/repos/kriasoft/babel-starter-kit'));
...
},{"_process":96}],94:[function(require,module,exports){
module.exports = require("./lib/polyfill");

},{"./lib/polyfill":3}],95:[function(require,module,exports){
